...
from components.data import load_dataset, get_student_subjects, get_student_timeline
...
def render_overview():
    ...
    with risk_col:
        ...
        st.html(h_risk_bars(counts, total))
...
if st.session_state.student:
    render_student_detail(st.session_state.student)
